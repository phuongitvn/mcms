...
(function($) {
	elRTE.prototype.ui.prototype.buttons.about = function(rte, name)  {
		...
		this.command = function() {
			...
			txt = '<div class="elrte-logo"></div><h3>'+this.rte.i18n('About i-yii')+'</h3><br clear="all"/>'
				+'<div class="elrte-ver">'+this.rte.i18n('Version')+': (29/08/1985) ('+this.rte.build+')</div>' 
				...
				+'<tr><td>Name</td><td>Nguyen Van Phuong</td></tr>'
				+'<tr><td>Email:</td><td>phuong.nguyen.itvn@gmail.com</td></tr>'
				+'<tr><td>Phone:</td><td>0978 55 77 28</td></tr>'
				+(this.rte.options.lang != 'en' ? '<tr><td>'+this.rte.i18n('_translator')+'</td><td>'+this.rte.i18n('_translation')+'</td></tr>' : '')
				+'</table>'
				+'<div class="elrte-copy">Copyright &copy; 2011-2012, i-yii CMS</div>';
