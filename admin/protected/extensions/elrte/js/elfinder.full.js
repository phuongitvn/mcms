...
elFinder.prototype.ui.prototype.commands = {
	...
	help : function(fm) {
		...
		this.exec = function() {
			...
			h = '<div class="el-finder-logo"/><strong>'+this.fm.i18n('i-file-man: Web file manager')+'</strong><br/>'+this.fm.i18n('Version')+': '+this.fm.version+'<br/>'
				+'jQuery/jQueryUI: '+$().jquery+'/'+$.ui.version+'<br clear="all"/>'
			h += '<p>'+(ht != 'helpText' ? ht : 'i-file-man works similar to file manager on your computer. <br /> To make actions on files/folders use icons on top panel. If icon action it is not clear for you, hold mouse cursor over it to see the hint. <br /> Manipulations with existing files/folders can be done through the context menu (mouse right-click).<br/> To copy/delete a group of files/folders, select them using Shift/Alt(Command) + mouse left-click.')+'</p>';
			h += '<p>'
				+ '<strong>'+this.fm.i18n('i-file-man support following shortcuts')+':</strong><ul>'
				...
				+ '<li><kbd>Space</kbd> - '+this.fm.i18n('Open/close QuickLook window')+'</li>'
			 	...
			 	+ '</p><p>'
			 	+ this.fm.i18n('Contacts us if you need help integrating elFinder in you products')+': phuong.nguyen.itvn@gmail.com</p>';

			a = '<div class="el-finder-help-std"/>'
				+'<p>'+this.fm.i18n('Name: Nguyen Van Phuong')+'</p>'
				+'<p>'+this.fm.i18n('Mail: phuong.nguyen.itvn@gmail.com')+'</p>'
				+'<p>'+this.fm.i18n('Phone: 0978 55 77 28')+'</p>';
			
			s = '<div class="el-finder-logo"/><strong>i-yii CMS</strong><br/>'
