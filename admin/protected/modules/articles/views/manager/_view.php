<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('url_source')); ?>:</b>
	<?php echo CHtml::encode($data->url_source); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('active_datetime')); ?>:</b>
	<?php echo CHtml::encode($data->active_datetime); ?>
	<br />
